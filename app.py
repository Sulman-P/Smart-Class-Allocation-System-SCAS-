...
# 2. Adjustable Streams (Increased Max to 20)
...
if uploaded_file is not None:
    try:
        ...
        if not all(col in df.columns for col in required_cols):
            ...
            # This loops over allocations, executing minor structural micro-swaps if targets miss metrics
            for _ in range(200): # Up to 200 refinement passes
                # Identify streams with maximum and minimum boarder count
                ...
                # Attempt to find a smart swap pair
                # We need a boarder from max_b_stream and a day student from min_b_stream
                ...
                # Double loop to find a pair whose scores are closest to minimize academic change
                for b_stud in max_stream_boarders:
                    for d_stud in min_stream_day:
                        # Project score change impact
                ...
                if best_swap:
                    ...
                    break # No clean candidate swap found without breaking marks constraint
